...
Now I have to check why I have a mismatch in PromotionKey. Apparently there are some promotions that have a key but no related information
...
Now I'm looking for the number of transactions that don't have a PromoMechanic but actually have a PromotionKey
...
Navbars <- fluidPage(theme = shinytheme("darkly"),
  navbarPage( 
  title = "OW - Hackatow",
  tabPanel("Exploratory Analysis",
           ...
           mainPanel(
             plotOutput(outputId = "Sales_Volumes")          
             )
           )
    )
  )
